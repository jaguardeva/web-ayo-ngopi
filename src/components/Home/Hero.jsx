      ...
      <section className="w-full max-w-[1420px] h-[calc(100vh-96px)] flex flex-col justify-center items-center mx-auto px-4 py-10 ">
        <div className="grid md:grid-cols-2 content-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <Link to="/menu">
              <button className=" text-[16px] md:text-[22px] py-3 md:py-4 px-5 md:px-8 font-semibold rounded-lg shadow-lg bg-[#EAC696]  text-[#65451f] hover:bg-opacity-80 uppercase">
                Our Menu
              </button>
            </Link>
          </div>
